...
/* ﾀｮｸ?､ｷ､ｿ､?1 (ﾈ?0?), ｼｺﾇﾔ､ｷ､ｿ､?0 */
int decode0_BMP(struct DLL_STRPICENV *env, int size, UCHAR *fp,
                int b_type, UCHAR *buf, int skip);
/* ･ｨ･鬘ｼ･ｳ｡ｼ･ﾉ､?ﾊﾖ､ｹ｡｣､ﾈ､熙｢､ｨ､ｺﾈ?0､ﾋ､ｷ､ﾆ､?､ﾀ､ｱ */
env､ﾏ64KB､ﾎ･?｡ｼ･ｯ･ｨ･?･｢､ﾇ､｢､?｡｣ﾀ霹ｬ8dw､ﾏﾊﾖ､?ﾃﾍﾍﾑ､ﾋ､ﾊ､ﾃ､ﾆ､､､?｡｣
ｴ?ﾈｯﾀｭ､鬢ｷ､ｯ, ･､･?･ｹ･ｿ･?･ｹﾊﾑｿ?ﾅｪ､ﾋ､ﾏｻﾈ､ｨ､ﾊ､､､隍ｦ､ﾀ｡｣JPEG_init､ﾇ
base_img､?ｺ?､?､ﾎ､ﾏdecode､ﾎ､ﾈ､ｭ､ﾀ､ｱ､ﾇ､､､､､ﾈｻﾗ､ｦ｡｣
%endif

[absolute 0]	;nask､ﾊ､饉section .bss] org 0 ､ｫ､ﾊ win32､ﾀ､ｫ､鬣ﾀ･皃ｫ
bmpinfo:
.regs:		resd 4
.reteip:	resd 1
.env:		resd 1
...
.endif:
	...
	;size､ｬｾｮ､ｵ､､ｾ?ｹ輊eight､?ｺ?､ﾃ､ﾆ､ﾇ､ 
	;ﾆﾉ､皃?､ﾈﾅ?､ｨ､?､ﾙ､ｭ､ﾀ､?､ｦ｡｣ｺ｣､ﾏ･ｨ･鬘ｼ
	push edx
	push eax
	...
	mov edx, eax
	add eax, byte 3			;size<1GB､?ｲｾﾄ熙ｷ､ﾆedx､?ﾌｵｻ 
	...
	pop edx
	add esi, eax
	add esi, edx			;ｺﾇｽｪｹﾔ､ﾎｺﾇｸ螟ﾋ､ﾏpudding､ｬ､ﾊ､､､ﾈｸｫ､?､ﾙ､ｭ
...
;***************************************************************
; ｾｮ､ｵ､ｵﾍ･ﾀ隍ﾇｺ?､ﾃ､ﾆ､､､?､ｬ, ﾂｮ､ｵﾍ･ﾀ隍ﾇｺ?､ﾃ､ｿﾀﾎ､ﾎ､隍熙､､､､ｫ､筍｣
; ﾉﾊｼﾁｺﾇﾄ网ﾎｹ篦ｮ･筍ｼ･ﾉ､ﾎ､ﾟｺ?､ﾃ､ﾆ､､､ 
...
.bpp24:
	...
	.do24.1:
	  ...
	  .do24.2:
	    ...
	    mov ax, [esi]
	     add esi, byte 3
	    ;ｸｺｿｧｽ靉? eax=24bitColor, edx=work, ecx=counter, ebx=work
	    ;ﾀ?ｹ遉ｵ､?､ﾎｼ?ﾌ｣､ﾇﾋﾗ､ﾃ､ｿ･?｡ｼ･ﾁ･?､?ｻ?､ﾃ､ﾆ､ｯ､?､筅隍ｷ(､ｩ
	    ;ｸ?ｺｹｳﾈｻｶ･?｡ｼ･ﾁ･?､?ｻ?､ﾃ､ﾆ､ｯ､?､筅隍ｷ
